...
/// admin################################################
    ...
    <table width="90%" height="40%" align = "center" >
        <tr align = "center">
            ...
            <td><?php echo "<a href='#?UserName=$UserName' ><img src='image/girl.png' class='size' ></a>" ?><br>
    ...
    <table width="30%" height="40%" align = "center" >
        <tr align = "center">
            <td ><?php echo "<a href='earrings_1.php?UserName=$UserName'><img src='image/earrings1.png' alt='animate' class='resize' ></a>" ?><br>
                <h3  class = "sarabun">ต่างหูเจาะ</h3></td>
            <td><?php echo "<a href='earrings_2.php?UserName=$UserName' ><img src='image/earrings.png' alt='animate' class='resize'></a>" ?><br>
                <h3 class = "sarabun">ต่างหูหนีบ</h3></td>
        </tr>
    </table>
    <?php
    $sqltxt = "SELECT * FROM acces WHERE TypeID LIKE '02%'";
